	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item "><a class="nav-link collapsed"
				href="Clients"> <i class="fas fa-fw fa-cog"></i> <span>Gestion
						des Clients</span>
			</a></li>
			<hr class="sidebar-divider">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="Coachs">
					<i class="fas fa-fw fa-wrench"></i> <span>Gestion des Coachs</span>
			</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="Paiements"> <i
					class="fas fa-fw fa-chart-area"></i> <span>Gestion des
						Paiements</span>
			</a></li>
			<hr class="sidebar-divider">
			<!-- Nav Item - Tables -->
			<li class="nav-item "><a class="nav-link" href="Cours"> <i
					class="fas fa-fw fa-table"></i> <span>Gestion des Cours</span>
			</a></li>
			<hr class="sidebar-divider">
			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="Equipement">
					<i class="fas fa-fw fa-table"></i> <span>Gestion des
						Equipements</span>
			</a></li>
				...
				<div class="container-fluid">
						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<script>
										var yearGainsList = ${yearGainsList	}; // Récupérer les données depuis la requête
										...
										yearGainsList.forEach(function(item) {
											years.push(item.year);
											gains.push(item.gains);
										});
					...
					<div class="col-xl-8 col-lg-7">
						<div class="card shadow mb-4">
							...
							<script >
								var yearClientsList = ${yearClientsJson	}; // Récupérer les données depuis la requête
								...
								// Parcourir les données et remplir les tableaux
								yearClientsList.forEach(function(item) {
									years.push(item.year);
									totalClients.push(item.totalClients);
								});
